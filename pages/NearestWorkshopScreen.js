...
class NearestWorkshopScreen extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <View style={styles.MainContainer}>
                <Text style={{ fontSize: 23 }}> أقرب ورشة </Text>
                <Button
                    title="My Data"
                    onPress={() => {
...
// NearestWorkshopScreen.navigationOptions = navData => {
//     return {
//         headerTitle: " أقرب ورشة ",
//         headerLeft: () => (
//             <HeaderButtons HeaderButtonComponent={HeaderButton}>
...
export default NearestWorkshopScreen;
